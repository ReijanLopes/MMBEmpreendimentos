...
export default function Menu() {
  return (
    <section
      className={`flex items-center justify-center px-6 lg:px-20 fixed min-h-screen w-full overflow-hidden z-[7] pointer-events-none header-hidden-animation`}
    >
      <div
        className={`w-full flex justify-between py-5 lg:py-10 min-h-screen transition-all duration-300 text-white header-text-animation pointer-events-none`}
      >
